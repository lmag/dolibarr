...
/**
 *	\file       htdocs/core/modules/project/task/doc/pdf_epaulard.modules.php
 *	\ingroup    project
 *	\brief      File of the class allowing to generate projects with the epaulard model
 */
...
/**
 *	Class to manage generation of task document epaulard
 */

class pdf_epaulard extends ModelePDFTask
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "epaulard";
		$this->description = $langs->trans("DocumentModelEpaulard");
	...
	/**
	 *  Function to build pdf task onto disk
	 *
	 *	@param	Project		$object   		Object project to generate
